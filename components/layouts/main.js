...
import VoxelLeaf from '../voxel-leaf'
  ...
  return (
    <Box as="main" pb={8}>
      <Head>
        ...
        <meta name="description" content="Yong's homepage" />
        ...
        <meta name="og:title" content="improve step three perfoemance." />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://www.craftz.dog/card.png" />
        <title>Yong - Homepage</title>
      </Head>
